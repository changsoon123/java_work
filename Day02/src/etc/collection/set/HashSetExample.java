...
public class HashSetExample {
	...
	public static void main(String[] args) {
		 ...
		 * 중복을 허용하지 않아서 중복 알고리즘에서 사용한다.
		 * 정해진것도 없다. 단순 모아둔 형태라서 빠르다.
		 * 
		 * 
		 * Hash
		...
		//객체를 저장: add(객체)
		//set은 인덱스가 없다.순서대로 들어가는 구조 x. 값의 집합만 표현
		 ...
		 * 반복자 (Iterator)를 통해서 요소를 하나씩 꺼내 보아야 한다.
...
//		//더 부르면 터진다.
		...
		//hasNext()가 객체를 더 가져오는지 확인후.true면 출력
		while(iter.hasNext()) {
			System.out.println(iter.next());
		}
		...
		//향상 for문이 iterator를 사용. for문은 원래 메서드(함수)이다
		for(String s:set) {
