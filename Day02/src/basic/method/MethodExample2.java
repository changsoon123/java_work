 ...
 *  ()안에 미리 개수 ( 매개 변수의 인수의 개수를 말하는거임)와 타입을 지정합니다.
 * 
 * 	4.매개 변수의 이름을 지을 때는 호출자가 선언부로 돌아와서
 * 	  매개 값을 확인하지 않게, 어떠한 값을 담는 변수인지
 *    그 뜻을 알기 쉽게 지어주면 서로에게 좋습니다.
 *    
 *  5. 매개 변수를 하나도 선언하지 않을 수도 있습니다. 이 때는 메서드의 선언부에
...
public class MethodExample2 {
	...
	//매개 변수가 필요 없는 경우
	// 조건문은 return 다 적어야 됨. 3중에 하나만 return이라 
...
//		
	...
	public static void main(String[] args) {
		...
		//아니면 배열로 포장해서 보내도 된다.
		int sum2 = calcNumberTotal2(new int[] {1,2,3,4,5,6,7});
